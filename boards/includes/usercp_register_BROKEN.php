	...
	$mode == 'register' )
{
	...
	$strip_var_list = array('email' => 'email', 'icq' => 'icq', 'aim' => 'aim', 'msn' => 'msn', 'yim' => 'yim', 'website' => 'website', 'location' => 'location', 'occupation' => 'occupation', 'interests' => 'interests', 'real_name' => 'real_name', 'gender' => 'gender', 'company' => 'company', 'picture' => 'picture', 'confirm_code' => 'confirm_code');
	...
	validate_optional_fields($icq, $aim, $msn, $yim, $website, $location, $occupation, $interests, $real_name, $gender, $company, $picture, $signature);
	...
	if ( (isset($HTTP_POST_VARS['avatargallery']) || isset($HTTP_POST_VARS['submitavatar']) || isset($HTTP_POST_VARS['cancelavatar'])) && (!isset($HTTP_POST_VARS['submit'])) )
	{
		...
		$signature = htmlspecialchars(stripslashes($signature));
  		$bio = htmlspecialchars(stripslashes($bio));
...
*/
	...
	if ( !$error )
	{
		...
		else
		{
			...
			// Get current date
			//
			$sql = "INSERT INTO " . USERS_TABLE . "	(user_id, username, user_regdate, user_password, user_email, user_icq, user_website, user_occ, user_from, user_interests, user_real_name, user_gender, user_company, user_picture, user_sig, user_sig_bbcode_uid, user_bio, user_bio_bbcode_uid, user_avatar, user_avatar_type, user_viewemail, user_aim, user_yim, user_msnm, user_attachsig, user_allowsmile, user_allowhtml, user_allowbbcode, user_allow_viewonline, user_notify, user_notify_pm, user_popup_pm, user_timezone, user_dateformat, user_lang, user_style, user_level, user_allow_pm, user_active, user_actkey)
