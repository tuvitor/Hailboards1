...
if ( isset($HTTP_POST_VARS['submit']) )
{
	...
	if ( !empty($HTTP_POST_VARS['username']) )
	{
		...
		// Protect Administrators from being banned
		if( $this_userdata['user_level'] == ADMIN)
		{
		   message_die(GENERAL_MESSAGE, $lang['No_admin_ban'] );
		}
		
		// Moderator Control Panel
		// Protect Moderators from being banned
		if( $this_userdata['user_level'] == MOD)
		{
		   message_die(GENERAL_MESSAGE, $lang['No_mod_ban'] );
		}
