...
else if ( $group_id )
{
	...
	//
	$sql = "SELECT username, user_id, user_viewemail, user_posts, user_rank, user_regdate, user_from, user_website, user_email, user_icq, user_aim, user_yim, user_msnm  
		FROM " . USERS_TABLE . " 
	...
	//
	$sql = "SELECT u.username, u.user_id, u.user_viewemail, u.user_posts, u.user_rank, u.user_regdate, u.user_from, u.user_website, u.user_email, u.user_icq, u.user_aim, u.user_yim, u.user_msnm, ug.user_pending 
	...
	$sql = "SELECT u.username, u.user_id, u.user_viewemail, u.user_posts, u.user_rank, u.user_regdate, u.user_from, u.user_website, u.user_email, u.user_icq, u.user_aim, u.user_yim, u.user_msnm
	...
	$template->assign_vars(array(
		...
		'MOD_USERNAME' => get_ranked_username($user_id,$group_moderator['username'],$group_moderator['user_rank'],$group_moderator['user_posts']),
		'MOD_FROM' => $from,
		'MOD_JOINED' => $joined,
		'MOD_POSTS' => $posts,
	...
	for($i = $start; $i < min($board_config['topics_per_page'] + $start, $members_count); $i++)
	{
		...
		if ( $group_info['group_type'] != GROUP_HIDDEN || $is_group_member || $is_moderator )
		{
			...
			$template->assign_block_vars('member_row', array(
				'ROW_COLOR' => '#' . $row_color,
				'ROW_CLASS' => $row_class,
				'USERNAME' => get_ranked_username($user_id,$group_members[$i]['username'],$group_members[$i]['user_rank'],$group_members[$i]['user_posts']),
				'FROM' => $from,
				'JOINED' => $joined,
				'POSTS' => $posts,
				'USER_ID' => $user_id, 
