...
$lang['Welcome_phpBB'] = 'Welcome to Hailboards!';
$lang['Admin_intro'] = 'Thank you for choosing Hailboards as your forum solution. This screen will give you a quick overview of all the various statistics of your board. You can get back to this page by clicking on the <u>Admin Index</u> link in the left pane. To return to the index of your board, click the Hailboards logo also in the left pane. The other links on the left hand side of this screen will allow you to control every aspect of your forum experience. Each screen will have instructions on how to use the tools.';
...
// Max Login Attempts - added 2.0.20
...
// Install Process
//
$lang['Welcome_install'] = 'Welcome to the hailBoards 1.2 Installer Script';
...
$lang['Re_install'] = 'Your previous installation is still active.<br /><br />If you would like to re-install hailBoards 1.2 you should click the Yes button below. Please be aware that doing so will destroy all existing data and no backups will be made! The administrator username and password you have used to login in to the board will be re-created after the re-installation and no other settings will be retained.<br /><br />Think carefully before pressing Yes!';

$lang['Inst_Step_0'] = 'Thank you for choosing hailBoards 1.2. In order to complete this install please fill out the details requested below. Please note that the database you install into should already exist. Please note that only MySQL is supported at this point.';
...
// Version Check
//
$lang['Version_up_to_date'] = 'Your installation is up to date, no updates are available for your version of Hailboards.';
$lang['Version_not_up_to_date'] = 'Your installation does <b>not</b> seem to be up to date. Updates are available for your version of hB, please visit <a href="http://www.hailboards.org/" target="_new">http://www.hailboards.org/</a> to obtain the latest version.';
$lang['Latest_version_info'] = 'The latest available version is <b>hB %s</b>.';
$lang['Current_version_info'] = 'You are running <b>hB %s</b>.';
$lang['Connect_socket_error'] = 'Unable to open connection to phpBB Server, reported error is:<br />%s';
$lang['Socket_functions_disabled'] = 'Unable to use socket functions.';
$lang['Mailing_list_subscribe_reminder'] = 'For the latest information on updates to Hailboards, why not <a href="http://www.hailboards.org/dev/" target="_new">visit our forum</a>.';
$lang['Version_information'] = 'Version Information';


// hb added - Avatar Controls - Dingo May 3rd, 2005
//
// Avatars
//
$lang['Title'] = "Title";
...
$lang['category_add'] = "Add a Category";
$lang['category_title'] = "Avatar Editing Controls";
$lang['category_desc'] = "From this page you can add, remove and edit the categories that your avatars are placed in for searching through.";
$lang['save_order'] = "Save Display Order";
$lang['avatar_add'] = "Add an Avatar";
$lang['category_add_success'] = "Added New Category Successfully";
$lang['click_return_avataradmin'] = "Click %sHere%s to return to Avatar Administration";
$lang['category_order_success'] = "Category Display Order Successfully Saved";
$lang['category_delete'] = "Delete a Category";
$lang['delete_avatars'] = "Delete all avatars in this Category?";
$lang['destination_category'] = "Destination Category";
$lang['category_delete_success'] = "Category Deleted Successfully";
$lang['avatar_title'] = "Avatar Editing Controls";
$lang['avatar_add'] = "Add an Avatar";
$lang['avatar_desc'] = "From this page you can add, remove and edit the avatars in your categories.";
$lang['image'] = "Image";
$lang['file_path'] = "Avatar File Path";
$lang['avatar_category'] = "Avatar Category";
$lang['avatar_add_success'] = "Added New Avatar Successfully";
$lang['avatar_delete'] = "Delete an Avatar";
$lang['avatar_delete_success'] = "Avatar Deleted Successfully";
$lang['include'] = "Include";
$lang['avatar_add_m'] = "Add Avatars";
