 ...
 *   copyright            : (C) 2001 The hailBoards Group
 *   email                : support@hailboards.org
 *
...
$faq[] = array("Linking to another site", "hailBoards BBCode supports a number of ways of creating URIs, Uniform Resource Indicators better known as URLs.<ul><li>The first of these uses the <b>[url=][/url]</b> tag; whatever you type after the = sign will cause the contents of that tag to act as a URL. For example, to link to hailboards.org you could use:<br /><br /><b>[url=http://www.hailboards.org/]</b>Visit hailBoards!<b>[/url]</b><br /><br />This would generate the following link, <a href=\"http://www.hailboards.org/\" target=\"_blank\">Visit hailBoards!</a> You will notice the link opens in a new window so the user can continue browsing the forums if they wish.</li><li>If you want the URL itself displayed as the link you can do this by simply using:<br /><br /><b>[url]</b>http://www.hailboards.org/<b>[/url]</b><br /><br />This would generate the following link: <a href=\"http://www.hailboards.org/\" target=\"_blank\">http://www.hailboards.org/</a></li><li>Additionally hailBoards features something called <i>Magic Links</i>which will turn any syntatically correct URL into a link without you needing to specify any tags or even the leading http://. For example typing www.hailboards.org into your message will automatically lead to <a href=\"http://www.hailboards.org/\" target=\"_blank\">www.hailboards.org</a> being output when you view the message.</li><li>The same thing applies equally to email addresses; you can either specify an address explicitly, like:<br /><br /><b>[email]</b>no.one@domain.adr<b>[/email]</b><br /><br />which will output <a href=\"emailto:no.one@domain.adr\">no.one@domain.adr</a> or you can just type no.one@domain.adr into your message and it will be automatically converted when you view.</li></ul>As with all the BBCode tags you can wrap URLs around any of the other tags such as <b>[img][/img]</b> (see next entry), <b>[b][/b]</b>, etc. As with the formatting tags it is up to you to ensure the correct open and close order is following. For example:<br /><br /><b>[url=http://www.hailboards.org/][img]</b>http://www.hailboards.org/images/phplogo.gif<b>[/url][/img]</b><br /><br />is <u>not</u> correct which may lead to your post being deleted so take care.");

$faq[] = array("--", "Showing images in posts");
$faq[] = array("Adding an image to a post", "hailBoards BBCode incorporates a tag for including images in your posts. Two very important things to remember when using this tag are: many users do not appreciate lots of images being shown in posts and second, the image you display must already be available on the Internet (it cannot exist only on your computer, for example, unless you run a webserver!). There is currently no way of storing images locally with hailBoards (all these issues are expected to be addressed in the next release of hailBoards). To display an image, you must surround the URL pointing to the image with <b>[img][/img]</b> tags. For example:<br /><br /><b>[img]</b>http://www.hailboards.org/images/phplogo.gif<b>[/img]</b><br /><br />As noted in the URL section above you can wrap an image in a <b>[url][/url]</b> tag if you wish, eg.<br /><br /><b>[url=http://www.hailboards.org/][img]</b>http://www.hailboards.org/images/phplogo.gif<b>[/img][/url]</b><br /><br />would generate:<br /><br /><a href=\"http://www.hailboards.org/\" target=\"_blank\"><img src=\"templates/subSilver/images/logo_hailBoards_med.gif\" border=\"0\" alt=\"\" /></a><br />");

$faq[] = array("--", "Highlighting text in posts");
$faq[] = array("Highlighting text in a post", "hailBoards BBCode uses a tag for adding color highlight formatting to text within a post.  An example:  [hl=lightblue]Greetings from the Hailboards Development Team![/hl] will generate highlighted text like this: <span style='background-color=lightblue;'>Greetings from the Hailboards Development Team!</span>");

$faq[] = array("--", "Other matters");
$faq[] = array("Can I add my own tags?", "No, I am afraid not directly in hailBoards 1.2. We are looking at offering customisable BBCode tags for the next major version.");
