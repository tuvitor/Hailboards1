<form method="post" action="{S_SPLIT_ACTION}">
  ...
  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="BoardRowA">
	<tr> 
	  <th height="25" class="thHead" colspan="3" nowrap="nowrap" class="BoardRowA"><b>{L_SPLIT_TOPIC}</b></th>
	</tr>
	<tr> 
	  <td class="BoardRowB" colspan="3" align="left"><span class="gensmall">{L_SPLIT_TOPIC_EXPLAIN}.<br><br> Moderators, please note that <b>Splitting Selected Posts</b> will create new threads from the posts you select. <b>Splitting From Selected Post</b> will cut a thread in half and create a new one starting with the thread you specify.</span></td>
	</tr>
	<tr> 
	...
	<tr> 
	  <th class="BoardRowA" nowrap="nowrap"><b>{L_AUTHOR}</b></th>
	  <th class="BoardRowA" nowrap="nowrap"><b>{L_MESSAGE}</b></th>
	  <th class="BoardRowA" nowrap="nowrap"><b>{L_SELECT}</b></th>
	</tr>
	<!-- BEGIN postrow -->
	<tr> 
	  ...
	  <td width="100%" valign="top" class="{postrow.ROW_CLASS}"> 
		<table width="100%" cellspacing="0" cellpadding="3" border="0">
		  <tr> 
			<td valign="middle" class="BoardRowA"><img src="templates/HBWinter/images/icon_minipost.gif" alt="{L_POST}"><span class="postdetails">{L_POSTED}: 
