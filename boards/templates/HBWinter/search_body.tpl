...
<form action="{S_SEARCH_ACTION}" method="POST"><table width="100%" cellspacing="2" cellpadding="2" border="0" align="center" class="BoardColumn">
	<tr> 
		<td align="left"><span class="nav"><a href="{U_INDEX}" class="BoardColumnLink">{L_INDEX}</a></span></td>
	</tr>
</table>

<table class="BoardRowB" width="100%" cellpadding="4" cellspacing="1" border="0">
	<tr> 
...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
	<tr> 
		<td align="right" valign="middle" class="BoardColumn"><span class="gensmall">{S_TIMEZONE}</span></td>
	</tr>
</table></form>

<table width="100%" border="0" class="BoardColumn">
	<tr>
		<td align="right" valign="top" class="BoardColumn">{JUMPBOX}</td>
	</tr>
</table>
