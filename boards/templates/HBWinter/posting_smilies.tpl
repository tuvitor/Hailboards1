...
<table width="100%" border="0" cellspacing="0" cellpadding="10" nowrap="nowrap">
	<tr>
		<td><table width="100%" border="0" cellspacing="1" cellpadding="4" class="BoardRowA">
			<tr>
				<th class="BoardColumn" height="25">{L_EMOTICONS}</th>
			</tr>
			<tr>
			...
			<tr>
				<td align="center"><br /><span class="genmed"><a href="javascript:window.close();" class="BoardRowBLink">{L_CLOSE_WINDOW}</a></span></td>
			</tr>
		</table></td>
	</tr>
</table>
