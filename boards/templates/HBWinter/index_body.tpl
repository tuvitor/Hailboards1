...
<table width="100%" cellpadding="4" cellspacing="0" border="0">
  <tr>
      <td width="65%" align="left" class="MainMenuRow"><font size="1">
      <script language="javascript" type="text/javascript">
<!--
	CFIG.writeButton();
// -->
      </script></font><a href="javascript:CFIG.cmd('collapseAll');" class="MainMenuLink">Hide Forums</a>&nbsp;|&nbsp;<a href="javascript:CFIG.cmd('expandAll');" class="MainMenuLink">Show Forums</a>&nbsp;|&nbsp;<a href="{U_MARK_READ}" class="MainMenuLink">{L_MARK_FORUMS_READ}</a></td>
      <td width="5%" align="left" class="MainMenuRow"><font size="1">Topics</font></td>
      <td width="5%" align="left" class="MainMenuRow"><font size="1">Posts</font></td>
      <td width="25%" align="right" class="MainMenuRow"><font size="1">Last Message</font></td>
   </tr>
</table>
<script language="javascript" type="text/javascript">
<!--
...
<tr id="forum_{catrow.CAT_ID}_{catrow.forumrow.FORUM_ID}" style="display:{catrow.forumrow.DISPLAY};">
     <td class="BoardRowA" width="3%" nowrap="nowrap">&nbsp;<img src="{catrow.forumrow.FORUM_FOLDER_IMG}" width="2" height="9">&nbsp;</td>
      <td width="62%" class="BoardRowB"><a class="SubjectLink" href="{catrow.forumrow.U_VIEWFORUM}">{catrow.forumrow.FORUM_NAME}</a>&nbsp;-&nbsp;<span class="ForumDescription">{catrow.forumrow.FORUM_DESC}</span></td>
      <td class="BoardRowA" width="5%" align="center">&nbsp;{catrow.forumrow.TOPICS}&nbsp;</td>
      <td class="BoardRowA" width="5%" align="center">&nbsp;{catrow.forumrow.POSTS}&nbsp;</td>
      <td class="BoardRowA" width="25%" align="right"><span style='font-size: 9px;'>&nbsp;{catrow.forumrow.LAST_POST_HB}</span></td>
    </tr>
<!-- END forumrow -->
<!-- END catrow -->
</table>
<table width="100%" cellpadding="3" cellspacing="0" border="0">
  <tr>
      <td class="MainMenuRow" width="50%">
      {TOTAL_USERS}
      </td>
      <td class="MainMenuRow" width="50%" align="right">
      {NEWEST_USER}
      </td>
  </tr>
</table>
