...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
  <tr> 
	<td align="left" class="MainMenuRow"><span class="MainMenuRow"><a href="{U_INDEX}" class="MainMenuLink">{L_INDEX}</a></span></td>
  </tr>
</table>

<table border="0" cellpadding="3" cellspacing="1" width="100%" class="BoardRowB">
	<tr> 
	...
	<!-- END avatar_row -->
  <tr>
    <td class="catBottom" colspan="{S_COLSPAN}" align="right">
    {PAGE_NUMBER}<br />
    {PAGINATION}</div>
    </td>
  </tr>
